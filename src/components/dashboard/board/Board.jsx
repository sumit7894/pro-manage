    ...
    <div className={styles.board__root}>
      <div className={styles.main__board}>
        <div className={styles.board__container}>
          <div className={styles.welcome__heading}>Welcome! {name}</div>
          <div className={styles.board__date}>{formattedDate}</div>
          <div className={styles.board__header}>
            <div className={styles.board__heading}>Board</div>
...
{/*------------------- Filter for cards-------------------------------------------------------- */}
              ...
              {showDropDown && (
                <div className={styles.dropdown__menu}>
                  <div onClick={() => handleFilter("Today")}>Today</div>
                  <div onClick={() => handleFilter("This Week")}>This Week</div>
                  <div onClick={() => handleFilter("This Month")}>
                    This Month
                  </div>
                </div>
              )}
...
{/*--------------------------- Rendering all cards based on the status---------------------------------- */}
